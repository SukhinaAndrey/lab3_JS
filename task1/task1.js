window.addEventListener('load', function () {
    ...
    let partner_man = ["Юрій", "Ігор", "Олександр", "Богдан", "Сергій"];
    let partner_woman = ["Юлія", "Катерина", "Ольга", "Карина", "Анастасія"];
    let country = ["Казахстан", "Шрі-Ланка", "Камбоджа", "США", "Аргентина"];
